...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['create_dept_role'])) {
    if (isset($_POST['update_id'])) {
        ...
        if ($name === '' || !$base_role_id) {
            ...
            if ($message === '') {
                // อัปเดตทั้ง base_role (text) และ base_role_id
...
// รายชื่อพนักงานในแผนก (สำหรับโหมดแก้ไข)
$employeesInDept = [];
if ($editing) {
...
// ตัวเลือกชนิดแผนกจากตาราง department_roles
                ...
                <form method="post">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-text">บทบาทหัวหน้าของชนิดแผนกถูกกำหนดในรายการนี้</div>
                        </div>
                        <div class="col-md-1">
